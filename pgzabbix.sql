...
# shamelessly copied from https://github.com/spotify/postgresql-metrics/blob/master/sql/run_on_monitored_postgres.sql
...
GRANT SELECT ON public.pg_stat_repl TO pgzabbix;
